export const Pages = [
  ...
  [
    "Prepare Linux Instances",
    "/spheron-protocol/provider-onboarding/prepare-linux-instances",
  ],
  ...
  ["Spheron CLI", "/spheron-cli"],
  ["Cloud CLI", "/spheron-cli/cloud-cli"],
  ["Protocol CLI", "/spheron-cli/protocol-cli"],
