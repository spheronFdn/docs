...
<Callout type="info">
  **NOTE:** \ When you run the `spheron login` command for the first time, a new
...
- `--organization` : The `organizationId` that you want to switch to.

<Callout type="info">
  **NOTE:** The prompter will be opened if the required param is not entered.
</Callout>
...
- `--organization` (Optional) : The `organizationId` whose details you want to get.

<Callout type="info">
  **NOTE:** The details of the default organization will be returned if the
  `organization` param is not entered.
</Callout>
...
- `--id` : The `deploymentId` whose details you want to get.
...
- `--projectId` : The `projectId` whose deployment details you want to get.
- `--skip` : The number of items to skip in the query.
...
<Callout type="info">
  **NOTE:** The projects of the default organization will be returned if the
  `organizationId` param is not entered.
</Callout>
