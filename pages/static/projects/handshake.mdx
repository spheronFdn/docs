...
4. Make the required changes and Click Update to update your handshake domain records. You will be redirected to the DNS settings page of [namebase.io](https://www.namebase.io/) with prefilled details. Upon successful confirmation, your records will be updated.
