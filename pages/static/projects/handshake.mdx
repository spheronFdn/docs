...
Handshake is a decentralized, permissionless naming protocol where every peer validates and manages the root DNS naming zone to create an alternative to existing Certificate Authorities and naming systems.
...
<Callout type="info">
  **NOTE:** \
  We are using Namebase to interact with Handshake Domains. Namebase is an NFT name registrar that operates on the Handshake blockchain. Namebase makes it easy to get your own NFT username on Handshake. You can use your Handshake name for secure login, decentralized websites, and top-level domain names.
</Callout>
...
5. Click Update to update your handshake domain records. You will be redirected to namebase.io. Upon successful confirmation, your records will be updated.
