...
4. With Spheron, you can update your ENS content hash directly from the app. Make the required changes and Click Update and confirm the transaction on Metamask to update the content hash. You can verify it in your ENS Domain Manager.
