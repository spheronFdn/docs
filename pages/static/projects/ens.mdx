...
## Update an ENS Domain

Follow these steps to update your ENS domain:

1. Select your project.
2. Select ENS Domains from the sidebar and Go to the 'Configure your ENS Domains/Subdomains' section under the Domains tab.
3. Select an ENS Domain that you wish to update. You will see the selected configuration on the screen.
