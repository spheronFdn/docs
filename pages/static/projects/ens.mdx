...
ENS (Ethereum Name Service) is a Blockchain domain naming protocol built especially for the Ethereum Blockchain. It allows you to create human-friendly and readable usernames for your dapps.
