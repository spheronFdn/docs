...
Version **2.0.0** of the `@spheron/storage` SDK brings significant changes and improvements.
...
- IPNS Records are now grouped at the bucket level. Please refer to the relevant section for more detailed information.
...
<Navigation name="Migrate <v2 to >v2" />
