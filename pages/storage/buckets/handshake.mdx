...
2. Go to the **Handshake Domains** tab in the **Domain** section under the **Buckets** tab.
...
1. Select your desired Bucket from the Storage dashboard.
2. Go to the **Handshake Subdomains** tab in the **Domain** section under the **Buckets** tab.
