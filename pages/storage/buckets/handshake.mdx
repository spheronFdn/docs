...
<Callout type="info">
  **NOTE:** \ We are using [Namebase](https://www.namebase.io/) to interact with
  Handshake Domains. Namebase is an NFT name registrar that operates on the
...
3. Enter your Handshake Domain name and Select the IPFS link that you want your domain to point to.
