...
```
You will receive output similar to: `{"address":"d5a824a1b4a7de20ef1fb697d13a7e4dc3147a28","crypto":{"ci …..`

4. Go to https://spheron-devnet.hub.caldera.xyz/

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719584176122/6944c5d8-748e-46b9-9633-f60a6fc4ace1.png)
...
We need to add some labels to the GPU nodes `akash.network/capabilities.gpu.vendor.nvidia.model.gpumodel=true` to activate GPU.
