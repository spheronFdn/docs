...
- **Daily Usage** \
  It calculates the average cost per day of your compute usage. It is useful for understanding how much you are spending on a daily basis and can help you identify trends in your usage.
- **Reserved** \
  It shows the amount reserved for the cluster.

## Detailed Cluster Usage

You can click on a cluster to know more about it in detail. It includes the following information related to your cluster usage:
...
- **Average Daily Cost** \
  It calculates the average cost per day of your compute usage. It is useful for understanding how much you are spending on a daily basis and can help you identify trends in your usage.
- **Total Reserved** \
  It shows the total amount reserved for the cluster.
- **Total Orders** \
...
- **Reserved** \
  It shows the amount reserved for the instance.
- **Status** \
  It shows the status of your instance.

<Navigation name="Usage" />
