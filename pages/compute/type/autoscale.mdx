...
15. You can create custom plans if required. [Click here](/compute/type/autoscale/#advanced-configuration) to know more.
...
- **CPU:** Define the CPU utilization threshold that, when exceeded, triggers a scaling action to increase the number of replicas.
- **RAM:** Specify the RAM utilization threshold that, when exceeded, triggers a scaling action to increase the number of replicas.

### Scale Down Policy

- **CPU:** Define the CPU utilization threshold that, when not met, triggers a scaling action to decrease the number of replicas.
- **RAM:** Specify the RAM utilization threshold that, when not met, triggers a scaling action to decrease the number of replicas.
