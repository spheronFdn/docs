...
Spheron offers Spot compute type in which the allocation of computational resources remains static and fixed.
...
## How to use Spot Type?

### With Docker

To use Spot type with a custom Docker image on Spheron:
...
To use Spot type with a marketplace app on Spheron:
