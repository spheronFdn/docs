...
By default, Spheron provides a subdomain when a cluster is deployed.
You can attach your domain and point it to an instance.
...
<Callout type="info">
  **NOTE:** \
  ...
  2\. You cannot add the same domain to different instances in the same cluster or separate clusters. To change your domain, you must delete it from the previous instance and add it to the new instance.
</Callout>
