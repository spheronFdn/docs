...
interface UsageWithLimits {
  used: {
    ...
    storageFilecoin: number, // the bytes of used Filecoin storage for the current subscription
  ...
  limit: {
    ...
    storageFilecoin: number, // the limit in bytes for the Filecoin storage for the current subscription
...
> Changes, there are a couple of new properties, storageFileoin, hns and ens domains ( not sure why they were missing) and optimized images
