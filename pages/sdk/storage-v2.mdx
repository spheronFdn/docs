...
- **maxSize** - (number) _optional_ - The maximum size of the upload in bytes. If the uploaded data size is exceeded an error will be thrown.
...
<Callout type="info">
  **NOTE:** Important: To execute the migration you need to use the token of the
  Storage organization, and you need to be the owner of both the Storage and the
  Static Site organizations. it.
</Callout>
