...
<Callout type="info">
  ...
  Web App organizations that are created after the release of version `2.0.0` will not work with the storage SDK versions `<2.0.0`.
...
- To migrate the buckets of your Web App organization to your new Storage organization, please refer to the [migrateWebAppOrgToStorage](/sdk/storage-v2/#migrate-buckets-from-static-site-organization) method in our documentation.
