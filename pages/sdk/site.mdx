...
interface UsageWithLimits {
  usedBandwidth?: number; // the number of bytes the current subscription has used
  bandwidthLimit?: number; // the limit of bytes the current subscription has
  usedBuildExecution?: number; // the number of seconds the current subscription has used to build projects
  buildExecutionLimit?: number; // the limit of seconds the current subscription has to build projects
  usedConcurrentBuild?: number; // the number of concurrent builds the current subscription has used
  concurrentBuildLimit?: number; // the limit of concurrent builds the current subscription has
  ...
  usedPasswordProtections?: number; // the number of password protections that are currently added to a project
  passwordProtectionLimit?: number; // the number of password protections that can be added to a project
  membersLimit?: number; // the number of members that can be added to an organization
}
```
