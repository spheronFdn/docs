...
Returns an object of type `Project`. Checkout the [update configuration section for more details about the configuration interface](/sdk/site/#updateconfiguration).
...
- Id of the project.
- `options`:
  - `name`: the name of the deployment environment. The name of the deployment environment needs to be unique for the project, else an error will be thrown.
  - `branches`: an array of strings, that represent the branches of the deployment environment. If a branch already exists in the Production deployment environment,
