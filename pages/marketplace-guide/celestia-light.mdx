...
Spheron allows you to deploy a compute instance pre-installed with Celestia, all set up and ready to use on the Akash Network.
...
5. Pick **Celestia Light Node** from the marketplace.
...
For more information, refer to the [Celestia docs](https://docs.celestia.org/nodes/docker-images).
