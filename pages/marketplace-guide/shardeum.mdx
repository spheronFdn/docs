...
6. Select your preferred **Region**, if any. If you do not add a region, the container will be deployed in the **us-east** region for **On Demand**. [Click here](/compute/cluster/#region) to know more.
