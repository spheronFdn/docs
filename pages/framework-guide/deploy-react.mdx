...
[React](https://reactjs.org/) is a JavaScript library for building user interfaces. React can be used as a base in the development of single-page, mobile, or server-rendered applications with frameworks like Next.js.

## Deploy React to Spheron

Follow these steps to deploy your first React app on Spheron successfully.
...
### Step 2: Update Your React.js Project to Deploy on Decentralised Storage
...
<Navigation name="Deploy React App" />
