...
<Callout>
  **Troubleshoot:** \ If your transaction fails and the amounts get deducted,
  you can click 'Already Paid?' in the transaction section. You can then enter
  the transaction hash, and if it is verified, your transaction will succeed.
</Callout>
