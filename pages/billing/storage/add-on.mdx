...
Review specific details about Add-ons here: [Available Add-ons](/billing/storage/storage-plan-details/#flexible-plan-upgrades).
...
2. Add payment methods if you haven't already. Check out the [Payment Methods](/billing/payment-method) section for more information.
3. Click "Buy Add-on" in the **[Add-on](https://app.spheron.network/#/app/billing/plan)** section.
4. Select the type of Add-on and the Add-on Amount.
5. To add more add-ons fields, Click "Add Add-on Field".
6. After adding all the add-on fields, Click "Review."
7. Read the add-on's payment details, and Click "Add" to initiate the payment.
8. Upon successful payment, the Add-on will be added.
...
1. Navigate to **Storage** from the navbar and Select the **Billing** tab.
2. Go to the **[Add-on](https://app.spheron.network/#/app/billing/plan)** section.
3. Click the delete icon beside the add-on you want to remove.
4. From the modal, Click "Remove" to stop its renewal.
