...
<Callout type="warning">Add-ons are accessible only to Pro users.</Callout>

Add-ons are bonus services accessible only to Pro users. If you are a Pro user and cross the usage limit of your subscription, you can increase these limits by adding add-ons.
