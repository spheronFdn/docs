...
4. Go to the [**Faucet**](https://www.alchemy.com/faucets/arbitrum-sepolia) to obtain some test gas tokens for the address you got from the previous step. These tokens will allow you to perform on-chain transactions.
...
```
provider update --config /home/spheron/.spheron/provider-config.json
```
</Callout>
...
```
provider provider get-attribute --category ["GPU"/"CPU"]
```
</Callout>
