...
**Note:** The first 1, 2, & 3 sections need to be done outside the server and it can be your personal laptop / desktop but shouldn't be inside the server, and then SSH to a remote server to set up everything for the provider.
</Callout>
