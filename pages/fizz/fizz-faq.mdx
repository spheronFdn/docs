...
Your node will go to Paused status if it performance is showing **No** for more than 5 days consecutively. To go to normal status, your node needs to show **Yes** for couple of days consecutively.
