...
4. Now click on the "Register Your Fizz Node" button. 

5. To complete the registration, you'll need pay a small registration fee of **0.02 ETH (Mainnet)** from any avilable chains. 

6. Click on **"Proceed with Payment"** button. [Why taking a fee?](/fizz/fizz-phase#why-didnt-earlier-phases-have-a-registration-fee-and-why-is-there-a-fee-in-phase-3)
