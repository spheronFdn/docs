...
```sh
sphnctl payment deposit --amount 50 --token USDC
```
...
```sh
sphnctl payment withdraw --amount 50 --token USDC
```
...
```sh
Available tokens:
Token: USDC, Precision: 6, TokenAddress: 0x24A05B480235Ccb450bf7Ce7e9F65072Ed732292
...
Deposit balance is sufficient: 16.537042 USDC 
