...
# Deploy Your App on Spheron Playground

This guide will walk you through the steps to deploy and access your app on Spheron Playground. Follow these steps carefully to ensure a successful deployment.
...
3. Deposit some USDC tokens to your wallet to pay for the deployment by clicking on the **Deposit** button in the top right corner.
4. You can also get some credit tokens (uSPON) from the Spheron team if you are building something super amazing. Reach out to us on [Discord](https://sphn.wiki/discord) for that.
...
3. You can check all the example ICL yaml files in the [Awesome Spheron Repo](https://github.com/spheronFdn/awesome-spheron). Or read more about ICL [here](/user-guide/icl).
4. Review your configuration and click **Start Deployment**
5. Wait for deployment (typically under 60 seconds)
