...
4. Reach out to the Spheron team on Discord's [#build-chat](https://sphn.wiki/discord) channel to get some USDT, USDC, or CST tokens.
...
<Callout type="info">
**Note:** 
- You won't get USDT, USDC, or CST tokens from the Spheron Faucet. You will need to reach out to the Spheron team to get these tokens on the Discord's [#build-chat](https://sphn.wiki/discord) channel.
