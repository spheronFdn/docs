...
### Get USDC tokens and ETH on Base Mainnet

1. First, get some ETH gas tokens on the Base mainnet and send it to your wallet address.

2. Then, get some USDC tokens on the Base mainnet and send it to your wallet address.

3. Check if you got the ETH for gas and USDC tokens in your wallet:
```
