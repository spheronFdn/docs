...
- `token` (string): The token symbol. Supported tokens are `uSPON` for payment on Spheron. Learn more about the tokens [here](/user-guide/supports#supported-payment-tokens).
